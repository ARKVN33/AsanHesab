...
namespace DAL.Class
{
    public class AsanHesabDbChanges
    {
        ...
        public async void Configurate()
        {
            ...
            const string connectionString = @"Data Source=(LocalDb)\v12.0;Database=dbAsanHesab;Integrated Security=True;Connect Timeout=30";
