...
namespace DAL.Class
{
    public class DUserLogin
    {
        ...
        public bool Login()
        {
            var result = _dbAsanHesabEntities.tblUser.FirstOrDefault(x => x.UserName == DUserName);
        ...
        public static bool? ChekAdminRegistered()
        {
            ...
            var result = dbAsanHesabEntities.tblSundry.FirstOrDefault(x => x.Id == 1);
        ...
        {
            var dbAsanHesabEntities = new dbAsanHesabEntities();
            var result = dbAsanHesabEntities.tblSecurityAccess.FirstOrDefault(x => x.Id == 1);
            if (result == null)
            {
                ...
                dbAsanHesabEntities.tblSecurityAccess.Add(tblSecurityAccess);
            ...
            else if (result.Time == null)
            {
                ...
                using (dbAsanHesabEntities)
                {
                    dbAsanHesabEntities.tblSecurityAccess.Attach(tblSecurityAccess);
                    dbAsanHesabEntities.Entry(tblSecurityAccess).Property(x => x.Time).IsModified = true;
                    dbAsanHesabEntities.SaveChanges();
                }
            }
        ...
        public static void SaveCounter(int num)//zakhire tedad mavared vorod eshtebah
        {
            ...
            {
                dbAsanHesabEntities.tblSecurityAccess.Attach(tblSecurityAccess);
                dbAsanHesabEntities.Entry(tblSecurityAccess).Property(x => x.Counter).IsModified = true;
                dbAsanHesabEntities.SaveChanges();
            }
        }
        ...
        {
            var dbAsanHesabEntities = new dbAsanHesabEntities();
            var firstOrDefault = dbAsanHesabEntities.tblSecurityAccess.FirstOrDefault(); //khandan etela-at file
